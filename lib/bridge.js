...
export class Bridge {
  ...
  */
  ...
  /** Chat language: "en" for English clients, "zh" otherwise. */
  lang(chat) {
    const l = String(this.runtime(chat)?.language ?? "").toLowerCase();
  ...
  */
  ...
  async processUpdate(u) {
    ...
    // Remember the user's app language so /help can answer in their language.
    if (msg.from?.language_code) this.runtime(chat).language = msg.from.language_code;
