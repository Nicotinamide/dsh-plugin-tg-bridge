  ...
  */
  ...
  async handleModelCommand(chat, arg, fromId) {
    ...
    try {
      ...
      const choice = { chatId: chat, clickerId: fromId, sessionId: sid, provider: hit.provider, model: hit.model, name: hit.name, efforts: supportedEfforts, chosen: null };
    ...
    if (responded && !denied) {
      try {
        if (this.permissionReply !== undefined) {
          ...
          this.effortReply = undefined;
        } else if (this.effoptReply !== undefined) {
          await this.tg.call("editMessageText", { chat_id: replyChat, message_id: tgMsgId, text: this.effoptReply });
          this.effoptReply = undefined;
